...
function StackupOpeningScreen({ onEnter }) {
  ...
  const openNotice=(type)=>{
    if(type==="bio") setNotice({title:"ATIVE O ACESSO BIOMÉTRICO",body:"Para usar a biometria, entre primeiro com Google ou WhatsApp. Depois você poderá ativar o acesso rápido neste dispositivo."});
    if(type==="wa") setNotice({title:"ENTRAR VIA WHATSAPP",body:"A interface está pronta para o OTP real. O envio só será ativado quando o provedor WhatsApp estiver configurado."});
    if(type==="google") setNotice({title:"ENTRAR COM GOOGLE",body:"A interface está pronta para o Google Identity. O acesso só será ativado quando o Client ID e o backend estiverem configurados."});
  };
  const Finger=()=> <svg viewBox="0 0 64 64" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" aria-hidden="true"><path d="M32 7C18 7 8 17 8 31m48 0C56 17 46 7 32 7M20 31c0-7 5-12 12-12s12 5 12 12c0 13-4 22-11 28M26 32c0-4 2-6 6-6s6 2 6 6c0 10-2 18-7 25M20 48c3-5 4-10 4-16"/></svg>;
  const Whats=()=> <svg viewBox="0 0 64 64" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M12 54l4-12a22 22 0 1 1 8 8z"/><path d="M24 20c-3 2-3 6 0 11 4 7 10 11 16 12 4 1 7-1 8-4l-7-4-4 3c-5-2-8-5-11-10l3-3z"/></svg>;
  const Google=()=> <span className="google-g" aria-hidden="true">G</span>;
  const EntryButton=({kind,title,sub,children})=><button className={"login-choice "+kind} type="button" onClick={()=>openNotice(kind)} aria-label={title}><span className="login-icon">{children}</span><span className="login-copy"><b>{title}</b><small>{sub}</small></span><span className="login-arrow">›</span></button>;
  return <div className="grinder-login"><style>{`
*{box-sizing:border-box}.grinder-login{min-height:100dvh;color:#fff;background:#080313;font-family:Arial,Helvetica,sans-serif;overflow-x:hidden}.login-scene{position:relative;width:min(100%,768px);min-height:100dvh;margin:auto;padding:calc(env(safe-area-inset-top) + 20px) clamp(24px,6vw,72px) calc(env(safe-area-inset-bottom) + 30px);display:flex;flex-direction:column;align-items:center;isolation:isolate;background:radial-gradient(ellipse at 50% 29%,rgba(75,19,125,.52),transparent 33%),radial-gradient(ellipse at 12% 52%,rgba(87,0,181,.3),transparent 27%),radial-gradient(ellipse at 90% 57%,rgba(125,0,180,.28),transparent 26%),linear-gradient(180deg,#080611 0%,#11031d 48%,#06020d 100%)}.login-scene:before{content:"";position:absolute;inset:0;z-index:-3;background:repeating-linear-gradient(132deg,transparent 0 37px,rgba(123,37,255,.045) 38px 40px,transparent 41px 78px);opacity:.65}.login-scene:after{content:"";position:absolute;left:0;right:0;bottom:0;height:30%;z-index:-2;background:radial-gradient(ellipse at 50% 100%,rgba(255,106,19,.28),transparent 36%),linear-gradient(176deg,transparent 0 35%,rgba(174,38,255,.22) 36% 37%,rgba(7,2,13,.9) 38%);pointer-events:none}
.light-beam{position:absolute;top:-4%;width:7px;height:34%;z-index:-1;background:linear-gradient(#ff9b36,#7a16ff 45%,transparent);filter:blur(1px);box-shadow:0 0 16px #7b19ff}.light-beam.l1{left:12%;transform:rotate(-25deg)}.light-beam.l2{left:29%;transform:rotate(-16deg)}.light-beam.r1{right:12%;transform:rotate(25deg)}.light-beam.r2{right:29%;transform:rotate(16deg)}
.login-logo-wrap{width:min(94vw,610px);height:clamp(330px,51vh,610px);margin-top:-14px;display:grid;place-items:center;position:relative}.login-logo{width:100%;height:100%;object-fit:contain;filter:drop-shadow(0 12px 16px #000) drop-shadow(0 0 8px rgba(255,103,18,.4));mix-blend-mode:screen}.login-logo-wrap:before,.login-logo-wrap:after{content:"";position:absolute;top:45%;width:22%;height:20%;z-index:-1;background:repeating-linear-gradient(0deg,#120b18 0 7px,#bc5b21 8px 10px,#08050c 11px 16px);border-radius:50%;filter:blur(.5px);opacity:.8;box-shadow:0 0 30px #6f13d8}.login-logo-wrap:before{left:-13%}.login-logo-wrap:after{right:-13%}
.welcome{text-align:center;margin-top:clamp(-28px,-2.6vh,-12px);text-shadow:0 3px 8px #000}.welcome h1{margin:0;font-size:clamp(32px,5.5vw,52px);font-weight:900;letter-spacing:.025em}.welcome p{margin:8px 0 14px;font-size:clamp(12px,2.25vw,20px);letter-spacing:.26em;color:#eee}.suits{display:flex;align-items:center;gap:17px;color:#a92cff;font-size:25px;font-weight:800}.suits:before,.suits:after{content:"";width:105px;height:3px;background:linear-gradient(90deg,transparent,#b52aff)}.suits:after{background:linear-gradient(90deg,#b52aff,transparent)}.suits .gold{color:#e0c69c}
.login-actions{width:100%;display:grid;gap:15px;margin-top:26px}.login-choice{position:relative;width:100%;min-height:94px;padding:12px 58px 12px 112px;border-radius:42px;border:2px solid #77768b;background:linear-gradient(110deg,rgba(39,39,50,.9),rgba(10,10,18,.94));color:#fff;text-align:left;display:flex;align-items:center;cursor:pointer;box-shadow:inset 0 1px 10px rgba(255,255,255,.07),0 9px 22px rgba(0,0,0,.5);transition:transform .13s,filter .13s}.login-choice:active{transform:scale(.98)}.login-choice.bio{border-color:#a62aff;background:radial-gradient(circle at 28% 50%,rgba(97,31,206,.92),rgba(32,6,79,.96) 55%,rgba(59,4,117,.96));box-shadow:inset 0 0 30px rgba(147,41,255,.35),0 0 15px #8c18ff}.login-icon{position:absolute;left:52px;width:58px;height:58px;border-radius:50%;display:grid;place-items:center;color:#fff}.login-icon svg{width:44px;height:44px}.bio .login-icon{border:2px solid #7c28ff;box-shadow:0 0 16px #8123ff}.wa .login-icon{color:#fff;background:#14d75e;border:2px solid #45ff8b;box-shadow:0 0 14px #0cdf5b}.google-g{font:bold 47px Arial;background:conic-gradient(from -45deg,#4285f4 0 25%,#34a853 0 45%,#fbbc05 0 65%,#ea4335 0 82%,#4285f4 0);-webkit-background-clip:text;color:transparent}.login-copy b{display:block;font-size:clamp(20px,3.5vw,30px);font-weight:800}.login-copy small{display:block;margin-top:4px;font-size:clamp(15px,2.5vw,22px);color:#d7d4df}.login-arrow{position:absolute;right:34px;top:50%;transform:translateY(-53%);font-size:58px;font-weight:200;line-height:1}
.login-legal{margin-top:28px;text-align:center;color:#d7d4df;font-size:clamp(13px,2vw,18px);line-height:1.55}.login-legal a{color:#cf3cff;font-weight:700;text-decoration:none;margin:0 6px}.corner-chip{position:absolute;bottom:-26px;width:132px;height:132px;border-radius:50%;z-index:-1;border:13px dashed #d17b36;background:radial-gradient(circle,#0b0710 0 35%,#9d531f 36% 40%,#09060d 41% 62%,#d07a33 63% 69%,#08050b 70%);box-shadow:0 0 22px #7418d8}.corner-chip.left{left:-43px}.corner-chip.right{right:-43px}
.login-modal{position:fixed;inset:0;z-index:50;background:#05020bd9;display:grid;place-items:center;padding:24px}.login-modal-card{width:min(100%,430px);border:1px solid #8d31df;border-radius:24px;padding:26px;background:linear-gradient(145deg,#20102e,#09060f);box-shadow:0 0 30px #7116bc;color:#fff}.login-modal-card h2{font-size:21px;margin:0 0 12px}.login-modal-card p{color:#d4cfdb;line-height:1.5}.login-modal-actions{display:grid;gap:9px;margin-top:20px}.login-modal-actions button{min-height:48px;border-radius:16px;border:1px solid #a534f4;background:#481276;color:#fff;font-weight:800}.login-modal-actions .secondary{background:#121019;border-color:#615b69}
@media(max-width:520px){.login-scene{padding-left:24px;padding-right:24px}.login-logo-wrap{height:43vh;min-height:300px}.login-choice{min-height:82px;padding-left:88px;border-radius:34px}.login-icon{left:28px;width:52px;height:52px}.login-icon svg{width:39px;height:39px}.login-actions{gap:12px;margin-top:20px}.login-legal{margin-top:22px}.suits:before,.suits:after{width:72px}}
@media(max-height:760px){.login-logo-wrap{height:315px}.welcome h1{font-size:30px}.welcome p{margin:5px 0 8px}.login-actions{margin-top:14px;gap:9px}.login-choice{min-height:70px}.login-legal{margin-top:14px}}
`}</style><main className="login-scene"><i className="light-beam l1"/><i className="light-beam l2"/><i className="light-beam r1"/><i className="light-beam r2"/>
<div className="login-logo-wrap"><img className="login-logo" src="/grinder-login-logo.jpg" alt="STACKUP HOLD'EM GRINDER — Decisões consistentes. Poker lucrativo."/></div>
<section className="welcome"><h1>BEM-VINDO</h1><p>TREINE. ENTENDA. EVOLUA NO POKER.</p><div className="suits"><span>♠</span><span>♥</span><span>♦</span><span className="gold">♣</span></div></section>
<section className="login-actions"><EntryButton kind="bio" title="Entrar com Biometria" sub="Acesso rápido e seguro"><Finger/></EntryButton><EntryButton kind="wa" title="Entrar via WhatsApp" sub="Receba um código de acesso"><Whats/></EntryButton><EntryButton kind="google" title="Entrar com Google" sub="Conta Google"><Google/></EntryButton></section>
<footer className="login-legal">Ao continuar, você concorda com nossos<br/><a href="/termos">Termos de Uso</a> e <a href="/privacidade">Política de Privacidade</a></footer><i className="corner-chip left"/><i className="corner-chip right"/></main>
{notice&&<div className="login-modal" role="dialog" aria-modal="true"><div className="login-modal-card"><h2>{notice.title}</h2><p>{notice.body}</p><div className="login-modal-actions">{notice.title.includes("BIOMÉTRICO")&&<><button onClick={()=>openNotice("google")}>ENTRAR COM GOOGLE</button><button onClick={()=>openNotice("wa")}>ENTRAR VIA WHATSAPP</button></>}<button className="secondary" onClick={()=>setNotice(null)}>FECHAR</button></div></div></div>}</div>;
}
