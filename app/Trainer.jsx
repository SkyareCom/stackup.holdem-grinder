...
function StackupOpeningScreen({ onLogin }) {
  ...
  return <main className="su-login">
    <style>{`
      ...
      .su-shell{width:min(100%,460px);margin:auto;padding:0 14px 24px}.su-hero{height:430px;margin:0 -14px 13px;position:relative;overflow:hidden;background:radial-gradient(circle at 50% 34%,#401052,#13041b 48%,#020103 80%);border-bottom:1px solid #46115f}.su-hero:before{content:"";position:absolute;inset:0;background:radial-gradient(circle at 50% 35%,transparent 0 28%,rgba(1,1,3,.12) 55%,rgba(1,1,3,.72) 100%);z-index:1;pointer-events:none}
      .su-aces{position:absolute;inset:28px 8px 118px;display:flex;justify-content:center;align-items:flex-start;gap:0;filter:blur(.55px) brightness(.58) saturate(.78) drop-shadow(0 12px 16px #000);opacity:.72}.su-ace{width:82px;height:126px;border:1px solid #b96bdc;border-radius:10px;background:linear-gradient(145deg,#1b1820,#060608);transform-origin:50% 100%;box-shadow:0 0 14px #8d24c855 inset;color:#d6b7e6;padding:8px;font:800 23px Georgia}.su-ace:nth-child(1){transform:rotate(-18deg) translate(14px,18px)}.su-ace:nth-child(2){transform:rotate(-7deg)}.su-ace:nth-child(3){transform:rotate(7deg)}.su-ace:nth-child(4){transform:rotate(18deg) translate(-14px,18px)}
      .su-medal{position:absolute;top:25px;left:50%;transform:translateX(-50%);width:190px;height:190px;border-radius:50%;border:12px double #f4f5f8;background:radial-gradient(circle at 48% 38%,#7335a0,#321048 52%,#100517 72%);display:grid;place-items:center;z-index:3;box-shadow:inset 0 0 0 8px #502068,inset 0 0 28px #000,0 0 22px #9f36d955;font:900 62px Georgia;color:#f6f7fa;text-shadow:0 2px 0 #737985,0 0 7px #fff6}.su-medal:before{content:"STK";font-family:"Viga",sans-serif;background:linear-gradient(180deg,#fff 0%,#f5f6fa 22%,#c9cdd6 43%,#9299a6 62%,#f5f6fa 80%,#4c515c 100%);-webkit-background-clip:text;background-clip:text;color:transparent;filter:drop-shadow(0 3px 1px #191b20);font-size:54px;letter-spacing:-4px}.su-medal{font-size:0}.su-brand{position:absolute;left:0;right:0;bottom:24px;text-align:center;z-index:4;text-shadow:0 5px 15px #000}.su-brand b{display:block;font-family:Impact,"Arial Black",sans-serif;font-style:italic;line-height:.82}.su-brand .stack{font-size:49px;letter-spacing:-1px;background:linear-gradient(180deg,#fff 0%,#f5f6fa 18%,#c9cdd6 38%,#9299a6 57%,#f4f5f7 76%,#777e89 100%);-webkit-background-clip:text;background-clip:text;color:transparent;filter:drop-shadow(0 3px 1px #24262c) drop-shadow(0 0 4px #fff2)}.su-brand .hold{font-size:38px;background:linear-gradient(180deg,#e167ff,#b52af0 38%,#7811b7 72%,#d84eff);-webkit-background-clip:text;background-clip:text;color:transparent}.su-brand .grinder{font-size:55px;background:linear-gradient(180deg,#e167ff,#b52af0 38%,#7811b7 72%,#d84eff);-webkit-background-clip:text;background-clip:text;color:transparent}.su-brand small{display:block;margin-top:10px;font-size:10px;letter-spacing:.2em;font-weight:800}
      .su-card{position:relative;width:100%;height:88px;margin:0 0 10px;padding:11px 44px 11px 17px;border:1px solid rgba(206,87,255,.78);border-radius:17px;background:linear-gradient(135deg,rgba(45,15,62,.82),rgba(7,5,13,.93));box-shadow:inset 0 1px 0 rgba(255,255,255,.06),0 10px 28px rgba(0,0,0,.38),0 0 11px rgba(177,47,255,.10);backdrop-filter:blur(16px);color:#fff;display:grid;grid-template-columns:48px 1fr;gap:13px;align-items:center;text-align:left;overflow:hidden}.su-card.active{border-color:#d65dff;box-shadow:inset 0 1px 0 #ffffff12,0 0 18px #a92cff28}.su-icon{width:38px;height:38px;color:#d690ff;z-index:2}.su-copy{z-index:2}.su-copy strong{display:block;font-family:"Viga",Inter,system-ui,sans-serif;font-size:18px;letter-spacing:.025em;font-weight:400}.su-copy small{display:block;margin-top:5px;color:#aa98b5;font-size:10.5px;font-weight:600}.su-water{position:absolute;width:112px;height:112px;right:-19px;top:-10px;color:#b64eea;opacity:.07}.su-chevron{position:absolute;right:15px;top:15px;width:20px;height:20px;color:#eee;transition:transform .24s}.su-chevron.up{transform:rotate(180deg)}
