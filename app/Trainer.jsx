...
function StackupOpeningScreen({ onEnter }) {
  ...
  const Suit=({type})=>{const p={viewBox:"0 0 64 64",fill:"currentColor","aria-hidden":"true"};if(type==="spade")return <svg {...p}><path d="M32 5C25 16 11 23 11 36c0 8 6 13 13 13 4 0 7-2 9-5-1 7-4 11-8 15h14c-4-4-7-8-8-15 2 3 5 5 9 5 7 0 13-5 13-13C53 23 39 16 32 5z"/></svg>;if(type==="heart")return <svg {...p}><path d="M32 56 9 34C-3 21 15 5 27 17l5 6 5-6C49 5 67 21 55 34z"/></svg>;if(type==="club")return <svg {...p}><path d="M32 7a12 12 0 0 0-7 22 11 11 0 1 0 3 18c-1 5-4 9-8 12h24c-4-3-7-7-8-12a11 11 0 1 0 3-18A12 12 0 0 0 32 7z"/></svg>;return <svg {...p}><path d="M32 5 55 32 32 59 9 32z"/></svg>};
...
.aces{position:absolute;z-index:0;left:-36px;right:-36px;top:4px;height:220px;display:flex;justify-content:center;filter:blur(.3px) brightness(.48) saturate(.58);opacity:.72}.ace{position:relative;width:116px;height:184px;border:1px solid #5b4825;border-radius:13px;background:radial-gradient(circle at 42% 34%,#191814 0,#090909 48%,#020202 100%);box-shadow:inset 0 0 0 1px #25231c,inset 0 0 30px #000,0 8px 22px #000;padding:10px;color:#d5aa52;transform-origin:50% 100%;overflow:hidden}.ace:after{content:"";position:absolute;inset:0;background:linear-gradient(115deg,transparent 28%,rgba(242,217,149,.05) 44%,transparent 58%);pointer-events:none}.ace-index{position:absolute;left:10px;top:9px;width:25px;z-index:2;color:#d8b461}.ace-index b{display:block;font:400 25px/22px Viga,sans-serif}.ace-index svg{display:block;width:16px;height:16px;margin:2px 0 0 2px}.ace>svg{position:absolute;width:54px;height:54px;left:50%;top:53%;transform:translate(-50%,-50%);color:#7d632f;opacity:.34}.ace:nth-child(1){transform:rotate(-21deg) translate(25px,31px)}.ace:nth-child(2){transform:rotate(-8deg) translate(5px,3px)}.ace:nth-child(3){transform:rotate(8deg) translate(-5px,3px)}.ace:nth-child(4){transform:rotate(21deg) translate(-25px,31px)}
.gold-brand{position:absolute;z-index:7;left:0;right:0;bottom:8px;text-align:center}.gold-brand b{display:block;font-family:Viga,sans-serif;line-height:.9;filter:drop-shadow(0 4px 2px #000)}.gold-stack{font-size:50px;background:linear-gradient(180deg,#fff,#e3e4e6 22%,#bfc1c5 43%,#85888e 61%,#e5e6e8 79%,#4f5257);-webkit-background-clip:text;background-clip:text;color:transparent}.gold-hold{font-size:36px;background:linear-gradient(180deg,#f2d995,#d5aa52 38%,#b98935 69%,#765022);-webkit-background-clip:text;background-clip:text;color:transparent}.gold-grinder{font-size:59px;background:linear-gradient(180deg,#e1bc6a,#b98935 34%,#8a6329 59%,#5e401c 78%,#c99b45);-webkit-background-clip:text;background-clip:text;color:transparent}.gold-brand small{display:block;margin-top:8px;color:#d7d8da;font-size:9px;letter-spacing:.25em;font-weight:700}
.gold-card{position:relative;width:100%;height:88px;margin:0 0 10px;padding:12px 43px 12px 16px;border:1px solid rgba(222,193,122,.76);border-radius:17px;background:linear-gradient(135deg,rgba(26,23,17,.72),rgba(3,3,3,.96));box-shadow:inset 0 1px rgba(255,245,210,.08),0 10px 24px #000c,0 0 9px #d5aa520d;backdrop-filter:blur(16px) saturate(115%);color:#fff;display:grid;grid-template-columns:48px 1fr;gap:13px;align-items:center;text-align:left;overflow:hidden}.gold-card:after{content:"";position:absolute;left:20px;top:-1px;width:38px;height:1px;background:linear-gradient(90deg,transparent,#f2d995,transparent);box-shadow:0 0 7px #d5aa5288}.gold-card.active{border-color:#f2d995}.gold-icon{width:38px;height:38px;color:#e6c879;z-index:2}.gold-icon svg,.gold-water svg,.gold-chevron svg{width:100%;height:100%}.gold-copy{z-index:2}.gold-copy strong{display:block;font:400 17px Viga,sans-serif;color:#e3c170}.gold-copy small{display:block;margin-top:5px;color:#aaa69c;font-size:10px}.gold-water{position:absolute;width:116px;height:116px;right:-21px;top:-15px;color:#d5aa52;opacity:.05}.gold-chevron{position:absolute;right:14px;top:34px;width:18px;height:18px;color:#f2d995;transition:.24s}.gold-chevron.up{transform:rotate(180deg)}
...
.table-glow{position:absolute;z-index:0;left:4%;right:4%;bottom:86px;height:150px;border-radius:50%;background:radial-gradient(ellipse,rgba(213,170,82,.10),rgba(15,14,11,.16) 38%,transparent 70%);filter:blur(7px);opacity:.55}
.chip-scene{position:absolute;z-index:1;bottom:118px;width:122px;height:110px;filter:brightness(.58) saturate(.55);opacity:.66}.chip-left{left:-18px;transform:rotate(-5deg)}.chip-right{right:-18px;transform:scaleX(-1) rotate(-5deg)}.chip-scene i{position:absolute;width:62px;height:16px;border-radius:50%;border:1px solid #8a6a32;background:repeating-conic-gradient(from 10deg,#171713 0 12deg,#b58a3d 12deg 18deg,#111 18deg 30deg);box-shadow:inset 0 2px #d2b36d33,inset 0 -4px #000,0 5px 8px #0009}.chip-scene i:nth-child(1){left:0;bottom:0}.chip-scene i:nth-child(2){left:0;bottom:10px}.chip-scene i:nth-child(3){left:0;bottom:20px}.chip-scene i:nth-child(4){left:0;bottom:30px}.chip-scene i:nth-child(5){left:0;bottom:40px}.chip-scene i:nth-child(6){left:51px;bottom:3px}.chip-scene i:nth-child(7){left:51px;bottom:13px}.chip-scene i:nth-child(8){left:51px;bottom:23px}.chip-scene i:nth-child(9){left:51px;bottom:33px}.chip-scene i:nth-child(10){left:27px;bottom:54px;transform:rotate(-17deg)}.chip-scene i:nth-child(11){left:34px;bottom:66px;transform:rotate(10deg)}.chip-scene i:nth-child(12){left:66px;bottom:51px;transform:rotate(18deg)}
.stk{position:absolute;z-index:3;top:18px;left:50%;transform:translateX(-50%);width:250px;height:250px;border-radius:50%;background:radial-gradient(circle at 47% 35%,#29251b 0,#0a0a09 47%,#020202 72%);border:8px solid #090909;box-shadow:0 0 0 2px #d5aa52,0 0 0 7px #15130f,0 0 0 10px #8a6329,inset 0 0 0 3px #d1a752,inset 0 0 38px #000,0 12px 34px #000e}
.stk-ring{position:absolute;inset:7px;border-radius:50%}.stk-ring span{position:absolute;left:50%;top:50%;width:25px;height:43px;margin:-21px -12px;border-radius:3px;background:linear-gradient(90deg,#2a2114 0,#c59b4e 24%,#f2d995 50%,#a77a32 73%,#241b10 100%);border:1px solid #3c2c16;box-shadow:inset 0 0 0 1px #e2c77b44,0 1px 2px #000;transform-origin:12px 112px}.stk-ring span:nth-child(1){transform:rotate(0deg) translateY(-86px)}.stk-ring span:nth-child(2){transform:rotate(45deg) translateY(-86px)}.stk-ring span:nth-child(3){transform:rotate(90deg) translateY(-86px)}.stk-ring span:nth-child(4){transform:rotate(135deg) translateY(-86px)}.stk-ring span:nth-child(5){transform:rotate(180deg) translateY(-86px)}.stk-ring span:nth-child(6){transform:rotate(225deg) translateY(-86px)}.stk-ring span:nth-child(7){transform:rotate(270deg) translateY(-86px)}.stk-ring span:nth-child(8){transform:rotate(315deg) translateY(-86px)}
.stk-spade{position:absolute;inset:30px;display:grid;place-items:center;color:#d5aa52;filter:drop-shadow(0 5px 2px #000)}.stk-spade svg{width:154px;height:154px;color:#d5aa52;filter:drop-shadow(0 0 1px #f2d995)}.stk-suits{position:absolute;inset:0}.stk-suits svg{position:absolute;width:15px;height:15px;color:#c39a4b;opacity:.9}.stk-suits svg:nth-child(1){left:50%;top:9px;transform:translateX(-50%)}.stk-suits svg:nth-child(2){right:10px;top:50%;transform:translateY(-50%) rotate(90deg)}.stk-suits svg:nth-child(3){left:50%;bottom:9px;transform:translateX(-50%) rotate(180deg)}.stk-suits svg:nth-child(4){left:10px;top:50%;transform:translateY(-50%) rotate(-90deg)}
.stk-word{position:absolute;inset:0;display:grid;place-items:center;font:400 61px Viga,sans-serif;letter-spacing:-5px;background:linear-gradient(180deg,#f2d995 0,#d5aa52 25%,#b98935 51%,#e0bd6d 69%,#60431e 100%);-webkit-background-clip:text;background-clip:text;color:transparent;filter:drop-shadow(0 4px 1px #000)}
.stk-mini-chips{position:absolute;left:36px;right:36px;bottom:45px;height:43px;z-index:4}.stk-mini-chips i{position:absolute;width:45px;height:12px;border:1px solid #a77c32;border-radius:50%;background:repeating-conic-gradient(#111 0 14deg,#c69b4d 14deg 21deg,#17140e 21deg 37deg);box-shadow:0 7px 0 #17140e,0 14px 0 #0c0b09,0 21px 0 #15120d}.stk-mini-chips i:nth-child(1){left:0}.stk-mini-chips i:nth-child(2){left:27px;bottom:5px}.stk-mini-chips i:nth-child(3){right:27px;bottom:5px}.stk-mini-chips i:nth-child(4){right:0}.stk-mini-chips i:nth-child(5){left:50%;margin-left:-21px;bottom:12px}
.stk-front-chip{position:absolute;z-index:6;right:22px;bottom:18px;width:67px;height:67px;border-radius:50%;border:7px dashed #d5aa52;background:radial-gradient(circle,#18140c 0 37%,#d0a44f 38% 42%,#080807 43% 61%,#b98935 62% 69%,#10100e 70%);transform:rotate(-19deg);box-shadow:0 8px 13px #000d,inset 0 0 0 2px #2b2114}
@media(max-width:370px){.gold-shell{padding-left:10px;padding-right:10px}.gold-hero{height:415px;margin-left:-10px;margin-right:-10px}.stk{width:214px;height:214px}.stk-spade{font-size:126px}.stk-word{font-size:52px}.stk-ring span{transform-origin:9px 94px}.stk-mini-chips{transform:scale(.9);transform-origin:center bottom}.gold-stack{font-size:44px}.gold-hold{font-size:35px}.gold-grinder{font-size:52px}.gold-copy strong{font-size:15px}.gold-auth,.gold-two{grid-template-columns:1fr}}
`}</style><div className="gold-shell">
    <section className="gold-hero">
      <div className="aces"><div className="ace"><div className="ace-index"><b>A</b><Suit type="spade"/></div><Suit type="spade"/></div><div className="ace"><div className="ace-index"><b>A</b><Suit type="heart"/></div><Suit type="heart"/></div><div className="ace"><div className="ace-index"><b>A</b><Suit type="club"/></div><Suit type="club"/></div><div className="ace"><div className="ace-index"><b>A</b><Suit type="diamond"/></div><Suit type="diamond"/></div></div>
      <div className="table-glow"/>
      <div className="chip-scene chip-left">
        <i/><i/><i/><i/><i/><i/><i/><i/><i/><i/><i/><i/>
      </div>
      <div className="chip-scene chip-right">
        <i/><i/><i/><i/><i/><i/><i/><i/><i/><i/><i/><i/>
      </div>
      <div className="stk">
        <div className="stk-ring"><span/><span/><span/><span/><span/><span/><span/><span/></div>
        <div className="stk-spade"><Suit type="spade"/></div><div className="stk-suits"><Suit type="spade"/><Suit type="spade"/><Suit type="spade"/><Suit type="spade"/></div>
        <div className="stk-word">STK</div>
        <div className="stk-mini-chips"><i/><i/><i/><i/><i/></div>
        <div className="stk-front-chip"/>
      </div>
