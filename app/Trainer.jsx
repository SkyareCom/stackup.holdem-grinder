...
.stk{position:absolute;z-index:3;top:8px;left:50%;transform:translateX(-50%);width:242px;height:242px;border-radius:50%;background:radial-gradient(circle at 47% 34%,#27241c 0,#0b0b09 53%,#020202 75%);border:9px solid #0c0c0b;box-shadow:0 0 0 2px #d5aa52,0 0 0 7px #17140e,0 0 0 9px #745324,inset 0 0 0 3px #c49a49,inset 0 0 30px #000,0 11px 30px #000d}
.stk-ring{position:absolute;inset:7px;border-radius:50%}.stk-ring span{position:absolute;left:50%;top:50%;width:18px;height:38px;margin:-19px -9px;border-radius:4px;background:linear-gradient(90deg,#49351a,#d0a85a 48%,#62471f);box-shadow:inset 0 0 0 1px #e2c77b55;transform-origin:9px 105px}.stk-ring span:nth-child(1){transform:rotate(0deg) translateY(-86px)}.stk-ring span:nth-child(2){transform:rotate(45deg) translateY(-86px)}.stk-ring span:nth-child(3){transform:rotate(90deg) translateY(-86px)}.stk-ring span:nth-child(4){transform:rotate(135deg) translateY(-86px)}.stk-ring span:nth-child(5){transform:rotate(180deg) translateY(-86px)}.stk-ring span:nth-child(6){transform:rotate(225deg) translateY(-86px)}.stk-ring span:nth-child(7){transform:rotate(270deg) translateY(-86px)}.stk-ring span:nth-child(8){transform:rotate(315deg) translateY(-86px)}
.stk-spade{position:absolute;inset:34px;display:grid;place-items:center;color:#c99b45;filter:drop-shadow(0 4px 2px #000)}.stk-spade svg{width:142px;height:142px;filter:drop-shadow(0 0 1px #f2d995);background:linear-gradient(135deg,#f2d995,#d5aa52 29%,#8a6329 52%,#e8c675 71%,#60431e);color:#d5aa52}.stk-suits{position:absolute;inset:0}.stk-suits svg{position:absolute;width:15px;height:15px;color:#c39a4b;opacity:.9}.stk-suits svg:nth-child(1){left:50%;top:9px;transform:translateX(-50%)}.stk-suits svg:nth-child(2){right:10px;top:50%;transform:translateY(-50%) rotate(90deg)}.stk-suits svg:nth-child(3){left:50%;bottom:9px;transform:translateX(-50%) rotate(180deg)}.stk-suits svg:nth-child(4){left:10px;top:50%;transform:translateY(-50%) rotate(-90deg)}
.stk-word{position:absolute;inset:0;display:grid;place-items:center;font:400 59px Viga,sans-serif;letter-spacing:-5px;background:linear-gradient(180deg,#f2d995,#d5aa52 27%,#b98935 49%,#e8c675 68%,#60431e);-webkit-background-clip:text;background-clip:text;color:transparent;filter:drop-shadow(0 3px 1px #000)}
.stk-mini-chips{position:absolute;left:31px;right:31px;bottom:43px;height:34px}.stk-mini-chips i{position:absolute;width:42px;height:11px;border:1px solid #a77c32;border-radius:50%;background:repeating-conic-gradient(#17140e 0 15deg,#c69b4d 15deg 22deg,#111 22deg 38deg);box-shadow:0 7px 0 #16130d,0 14px 0 #0c0b09}.stk-mini-chips i:nth-child(1){left:0}.stk-mini-chips i:nth-child(2){left:27px;bottom:5px}.stk-mini-chips i:nth-child(3){right:27px;bottom:5px}.stk-mini-chips i:nth-child(4){right:0}.stk-mini-chips i:nth-child(5){left:50%;margin-left:-21px;bottom:12px}
.stk-front-chip{position:absolute;right:28px;bottom:20px;width:59px;height:59px;border-radius:50%;border:6px dashed #d5aa52;background:radial-gradient(circle,#18140c 0 43%,#b98935 44% 49%,#0c0b09 50% 66%,#d5aa52 67% 72%,#111 73%);transform:rotate(-19deg);box-shadow:0 7px 10px #000b}
