...
.stk{position:absolute;z-index:3;top:12px;left:50%;transform:translateX(-50%);width:238px;height:238px;border-radius:50%;background:radial-gradient(circle at 47% 34%,#27241c 0,#0b0b09 53%,#020202 75%);border:9px solid #0c0c0b;box-shadow:0 0 0 2px #d5aa52,0 0 0 7px #17140e,0 0 0 9px #745324,inset 0 0 0 3px #c49a49,inset 0 0 30px #000,0 11px 30px #000d}
...
.stk-spade{position:absolute;inset:27px;display:grid;place-items:center;font:900 142px Georgia;background:linear-gradient(135deg,#f2d995 0,#d5aa52 27%,#8a6329 49%,#e8c675 68%,#60431e 100%);-webkit-background-clip:text;background-clip:text;color:transparent;filter:drop-shadow(0 4px 2px #000) drop-shadow(0 0 1px #f4dda3)}
