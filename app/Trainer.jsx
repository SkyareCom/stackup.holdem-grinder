...
.gold-hero{height:485px;margin:0 -14px 12px;position:relative;overflow:hidden;background:radial-gradient(circle at 50% 28%,#252016 0,#0b0b09 45%,#020202 80%);border-bottom:1px solid #3d3320}.gold-hero:after{content:"";position:absolute;inset:0;z-index:2;background:linear-gradient(180deg,transparent 52%,rgba(0,0,0,.18) 68%,#020202 100%);pointer-events:none}
.aces{position:absolute;z-index:0;left:-18px;right:-18px;top:22px;height:230px;display:flex;justify-content:center;filter:blur(.65px) brightness(.62) saturate(.72);opacity:.72}.ace{position:relative;width:108px;height:168px;border:1px solid #6e5a32;border-radius:13px;background:linear-gradient(145deg,#151513,#050505);box-shadow:inset 0 0 20px #000,0 5px 18px #000;padding:11px;color:#d5aa52;font:400 25px Viga,sans-serif;transform-origin:50% 100%}.ace span{display:block;line-height:.88}.ace:nth-child(1){transform:rotate(-20deg) translate(22px,32px)}.ace:nth-child(2){transform:rotate(-7deg)}.ace:nth-child(3){transform:rotate(7deg)}.ace:nth-child(4){transform:rotate(20deg) translate(-22px,32px)}
.chips{position:absolute;z-index:1;bottom:135px;width:88px;height:78px;opacity:.52;filter:blur(.45px) brightness(.66)}.chips.left{left:-9px}.chips.right{right:-9px}.chips:before,.chips:after{content:"";position:absolute;left:0;right:0;height:18px;border:2px solid #6d572d;border-radius:50%;background:linear-gradient(#24231f,#090909);box-shadow:0 14px 0 #111,0 28px 0 #171612,0 42px 0 #0d0d0c}.chips:after{left:37px;top:9px;right:-18px}
.stk{position:absolute;z-index:3;top:18px;left:50%;transform:translateX(-50%);width:224px;height:224px;border-radius:50%;background:radial-gradient(circle at 48% 36%,#2b271e,#0c0c0a 56%,#020202 75%);border:11px solid #111;box-shadow:0 0 0 2px #d5aa52,0 0 0 8px #17140d,inset 0 0 0 3px #b98935,inset 0 0 28px #000,0 0 18px #b9893529}.stk:before{content:"♠";position:absolute;inset:25px;display:grid;place-items:center;font:900 134px Georgia;background:linear-gradient(135deg,#f2d995,#d5aa52 31%,#8a6329 51%,#e8c675 72%,#60431e);-webkit-background-clip:text;background-clip:text;color:transparent;filter:drop-shadow(0 4px 2px #000)}.stk:after{content:"STK";position:absolute;inset:0;display:grid;place-items:center;font:400 57px Viga,sans-serif;letter-spacing:-5px;background:linear-gradient(180deg,#f2d995,#d5aa52 27%,#b98935 49%,#e8c675 68%,#60431e);-webkit-background-clip:text;background-clip:text;color:transparent;filter:drop-shadow(0 3px 1px #000)}
.gold-brand{position:absolute;z-index:4;left:0;right:0;bottom:22px;text-align:center}.gold-brand b{display:block;font-family:Viga,sans-serif;line-height:.9;filter:drop-shadow(0 4px 2px #000)}.gold-stack{font-size:48px;background:linear-gradient(180deg,#fff,#e3e4e6 22%,#bfc1c5 43%,#85888e 61%,#e5e6e8 79%,#4f5257);-webkit-background-clip:text;background-clip:text;color:transparent}.gold-hold{font-size:38px;background:linear-gradient(180deg,#f2d995,#d5aa52 38%,#b98935 69%,#765022);-webkit-background-clip:text;background-clip:text;color:transparent}.gold-grinder{font-size:57px;background:linear-gradient(180deg,#e1bc6a,#b98935 34%,#8a6329 59%,#5e401c 78%,#c99b45);-webkit-background-clip:text;background-clip:text;color:transparent}.gold-brand small{display:block;margin-top:11px;color:#d7d8da;font-size:9px;letter-spacing:.25em;font-weight:700}
.gold-card{position:relative;width:100%;height:86px;margin:0 0 10px;padding:12px 43px 12px 16px;border:1px solid rgba(222,193,122,.75);border-radius:17px;background:linear-gradient(135deg,rgba(28,25,19,.78),rgba(5,5,5,.94));box-shadow:inset 0 1px rgba(255,245,210,.10),0 10px 24px #000b,0 0 12px #d5aa5212;backdrop-filter:blur(16px) saturate(115%);color:#fff;display:grid;grid-template-columns:48px 1fr;gap:13px;align-items:center;text-align:left;overflow:hidden}.gold-card.active{border-color:#f2d995}.gold-icon{width:38px;height:38px;color:#dec17a;z-index:2}.gold-icon svg,.gold-water svg,.gold-chevron svg{width:100%;height:100%}.gold-copy{z-index:2}.gold-copy strong{display:block;font:400 17px Viga,sans-serif;color:#e8c675}.gold-copy small{display:block;margin-top:5px;color:#aaa69c;font-size:10px}.gold-water{position:absolute;width:116px;height:116px;right:-21px;top:-15px;color:#b98935;opacity:.055}.gold-chevron{position:absolute;right:14px;top:34px;width:18px;height:18px;color:#dec17a;transition:.24s}.gold-chevron.up{transform:rotate(180deg)}
