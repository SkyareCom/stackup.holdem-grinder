...
function StackupOpeningScreen({ onLogin }) {
  ...
  return <main className="su-login">
    <style>{`
      ...
      .su-shell{width:min(100%,460px);margin:auto;padding:0 14px 24px}.su-hero{height:455px;margin:0 -14px 12px;position:relative;overflow:hidden;background:radial-gradient(circle at 50% 34%,#401052,#13041b 48%,#020103 80%);border-bottom:1px solid #46115f}.su-hero:before{content:"";position:absolute;inset:0;background:radial-gradient(circle at 50% 35%,transparent 0 28%,rgba(1,1,3,.12) 55%,rgba(1,1,3,.72) 100%);z-index:1;pointer-events:none}
      .su-aces{position:absolute;inset:28px 8px 118px;display:flex;justify-content:center;align-items:flex-start;gap:0;filter:blur(1.1px) brightness(.46) saturate(.70) drop-shadow(0 12px 16px #000);opacity:.60}.su-ace{width:82px;height:126px;border:1px solid #b96bdc;border-radius:10px;background:linear-gradient(145deg,#1b1820,#060608);transform-origin:50% 100%;box-shadow:0 0 14px #8d24c855 inset;color:#d6b7e6;padding:8px;font:800 23px Georgia}.su-ace:nth-child(1){transform:rotate(-18deg) translate(14px,18px)}.su-ace:nth-child(2){transform:rotate(-7deg)}.su-ace:nth-child(3){transform:rotate(7deg)}.su-ace:nth-child(4){transform:rotate(18deg) translate(-14px,18px)}
      .su-medal{position:absolute;top:18px;left:50%;transform:translateX(-50%);width:215px;height:215px;border-radius:50%;border:12px double #f4f5f8;background:radial-gradient(circle at 48% 38%,#7335a0,#321048 52%,#100517 72%);display:grid;place-items:center;z-index:3;box-shadow:inset 0 0 0 8px #502068,inset 0 0 28px #000,0 0 22px #9f36d955;font:900 62px Georgia;color:#f6f7fa;text-shadow:0 2px 0 #737985,0 0 7px #fff6}.su-medal:before{content:"STK";font-family:"Viga",sans-serif;background:linear-gradient(180deg,#fff 0%,#f5f6fa 22%,#c9cdd6 43%,#9299a6 62%,#f5f6fa 80%,#4c515c 100%);-webkit-background-clip:text;background-clip:text;color:transparent;filter:drop-shadow(0 3px 1px #191b20);font-size:58px;letter-spacing:-5px}.su-medal{font-size:0;box-shadow:0 0 0 2px #f5f6fa,0 0 0 8px #4d1764,inset 0 0 0 3px #c9cdd6,inset 0 0 28px #000,0 0 22px #a832dc55}.su-brand{position:absolute;left:0;right:0;bottom:22px;text-align:center;z-index:4;text-shadow:0 5px 15px #000}.su-brand b{display:block;font-family:Impact,"Arial Black",sans-serif;font-style:italic;line-height:.82}.su-brand .stack{font-size:47px;letter-spacing:-1px;background:linear-gradient(180deg,#fff 0%,#f5f6fa 18%,#c9cdd6 38%,#9299a6 57%,#f4f5f7 76%,#777e89 100%);-webkit-background-clip:text;background-clip:text;color:transparent;filter:drop-shadow(0 3px 1px #24262c) drop-shadow(0 0 4px #fff2)}.su-brand .hold{font-size:37px;background:linear-gradient(180deg,#e167ff,#b52af0 38%,#7811b7 72%,#d84eff);-webkit-background-clip:text;background-clip:text;color:transparent}.su-brand .grinder{font-size:56px;background:linear-gradient(180deg,#e167ff,#b52af0 38%,#7811b7 72%,#d84eff);-webkit-background-clip:text;background-clip:text;color:transparent}.su-brand small{display:block;margin-top:11px;font-size:9px;letter-spacing:.25em;font-weight:700;color:#d5d5dc}
      .su-card{position:relative;width:100%;height:86px;margin:0 0 10px;padding:11px 44px 11px 17px;border:1px solid rgba(206,87,255,.78);border-radius:17px;background:linear-gradient(135deg,rgba(45,15,62,.72),rgba(7,5,13,.90));box-shadow:inset 0 1px 0 rgba(255,255,255,.06),0 10px 28px rgba(0,0,0,.38),0 0 11px rgba(177,47,255,.10);backdrop-filter:blur(16px) saturate(135%);color:#fff;display:grid;grid-template-columns:48px 1fr;gap:13px;align-items:center;text-align:left;overflow:hidden}.su-card.active{border-color:#d65dff;box-shadow:inset 0 1px 0 #ffffff12,0 0 18px #a92cff28}.su-icon{width:38px;height:38px;color:#d690ff;z-index:2}.su-copy{z-index:2}.su-copy strong{display:block;font-family:"Viga",Inter,system-ui,sans-serif;font-size:17px;letter-spacing:.025em;font-weight:400}.su-copy small{display:block;margin-top:5px;color:#aa98b5;font-size:10.5px;font-weight:600}.su-water{position:absolute;width:116px;height:116px;right:-21px;top:-15px;color:#b64eea;opacity:.06}.su-chevron{position:absolute;right:15px;top:15px;width:20px;height:20px;color:#eee;transition:transform .24s}.su-chevron.up{transform:rotate(180deg)}
      ...
      .su-grid{display:grid;gap:9px}.su-two{grid-template-columns:1fr 1fr}.su-choice,.su-action{min-height:48px;border:1px solid #59436c;border-radius:11px;background:linear-gradient(135deg,#13101d,#09070e);color:#fff;font:400 11px "Viga",Inter,system-ui;letter-spacing:.02em}.su-choice.selected{border-color:#c844ff;box-shadow:0 0 12px #a229e52e,inset 0 0 14px #7b1aa122}.su-action.primary{border-color:#bc42ff;background:linear-gradient(135deg,#9217ef,#6410b6);box-shadow:inset 0 1px #ffffff26,0 5px 15px #6410b644}.su-auth{display:grid;grid-template-columns:1fr 1fr;gap:9px}.su-auth button{display:grid;grid-template-columns:34px 1fr;align-items:center;text-align:left;padding:8px 10px}.su-auth svg{width:27px;height:27px;color:#e1b9ff}.su-auth b{font-family:"Viga",Inter,system-ui,sans-serif;font-size:10.5px;font-weight:400}.su-auth small{display:block;color:#8f8299;font-size:8px;margin-top:3px}.su-google{font-size:25px;font-weight:900;color:#fff}
      .su-phone{display:grid;grid-template-columns:88px 1fr;gap:8px}.su-country,.su-field{height:48px;border:1px solid #59436c;border-radius:10px;background:#090811;color:#fff}.su-country{display:flex;align-items:center;justify-content:center;gap:5px;font-family:"Viga",Inter,system-ui,sans-serif;font-weight:400;font-size:12px}.su-field{width:100%;padding:0 13px;font-size:14px;outline:none}.su-field:focus,.su-otp:focus{border-color:#c84cff;box-shadow:0 0 0 2px #a83aff24,0 0 14px #9b2ee82b}.su-send{margin-top:9px;width:100%;height:48px;display:flex;align-items:center;justify-content:center;gap:9px}.su-send svg{width:21px}.su-otps{display:flex;gap:8px;margin-top:10px}.su-otp{width:50px;height:52px;border:1px solid #65427a;border-radius:10px;background:#08070d;color:#fff;text-align:center;font-size:21px;font-weight:800;outline:none}.su-keep{display:grid;grid-template-columns:20px 1fr;gap:9px;align-items:start;margin:12px 1px;color:#fff;font-size:10px;font-weight:800}.su-keep input{width:18px;height:18px;accent-color:#a91ee9;margin:0}.su-keep small{display:block;color:#85778f;font-size:8px;margin-top:3px;font-weight:500}.su-actions{display:grid;grid-template-columns:1fr 1fr;gap:9px;margin-top:11px}.su-foot{display:flex;align-items:center;gap:12px;justify-content:center;padding:12px 0 4px;color:#b94cff;font-size:8px;letter-spacing:.23em;white-space:nowrap}.su-foot:before,.su-foot:after{content:"";height:1px;flex:1;background:linear-gradient(90deg,transparent,#8120a8)}.su-foot:after{background:linear-gradient(90deg,#8120a8,transparent)}
      @media(max-width:370px){.su-shell{padding-left:10px;padding-right:10px}.su-hero{margin-left:-10px;margin-right:-10px;height:405px}.su-medal{width:172px;height:172px}.su-medal:before{font-size:48px}.su-brand .stack{font-size:45px}.su-brand .hold{font-size:35px}.su-brand .grinder{font-size:50px}.su-copy strong{font-size:16px}.su-auth{grid-template-columns:1fr}.su-two{grid-template-columns:1fr}.su-card{height:84px}}
    `}</style>
